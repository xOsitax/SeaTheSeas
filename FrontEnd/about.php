                ...
                <div class="row d-flex align-items-center justify-content-between">
                        ...
                        <div class="about-content">
                            ...
                            <div class="about-imagelist">
                                <ul class="d-flex justify-content-between">
                                    <li class="mr-2">
                                        <img src="images/destination/aboutus/aboutus1.png" alt="">
                                    </li>
                                    <li class="mr-2">
                                        <img src="images/destination/aboutus/aboutus8.png" alt="">
                                    </li>
                                    <li class="mr-2">
                                        <img src="images/destination/aboutus/aboutus3.png" alt="">
                                    </li>
                                    <li class="mr-2">
                                        <img src="images/destination/aboutus/aboutus4.png" alt="">
                                    </li>
                                    <li>
                                        <img src="images/destination/aboutus/aboutus2.png" alt="">
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="about-image">
                            <img src="images/destination/aboutus/aboutus6.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="about-image-main">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 mt-4 mb-4">
                                    <img src="images/destination/aboutus/aboutuswhy1.png" alt="">
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <img src="images/destination/aboutus/aboutuswhy2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <div class="why-us-item text-center bg-lgrey">
                                ...
                                <div class="why-us-content">
                                    ...
                                    <p class="mb-0">We are always able to help, 24 hours a day</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <div class="why-us-item text-center bg-lgrey">
                                <div class="why-us-icon mb-2">
                                    <i class="flaticon-yatch-with-sails pink"></i>
                                </div>
                                <div class="why-us-content">
                                    <h4><a href="#">Food Adventures</a></h4>
                                    <p class="mb-0">Finding ways to learn about the Food of Italy is important</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <div class="why-us-item text-center bg-lgrey">
                                ...
                                <div class="why-us-content">
                                    ...
                                    <p class="mb-0">We provide hotel options close by to popular destination sites.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                            <div class="why-us-item text-center bg-lgrey">
                                ...
                                <div class="why-us-content">
                                    <h4><a href="#">Pre Built Itineraries</a></h4>
                                    <p class="mb-0">Downloadable and sharable itineraries for easy convenience</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-line-inner">
                <div class="row d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <a href="contact.html" class="nir-btn">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>   
            ...
            <div class="row review-slider">
                <div class="col-sm-4 item">
                    <div class="testimonial-item1 text-center">
                        ...
                        <div class="author-info mt-2">
                            <a href="#"><img src="images/destination/testimonial/testimonial1.png" alt=""></a>
                ...
                <div class="col-sm-4 item">
                    <div class="testimonial-item1 text-center">
                        ...
                        <div class="author-info mt-2">
                            <a href="#"><img src="images/destination/testimonial/testimonial2.png" alt=""></a>
                            <div class="author-title">
                ...
                <div class="col-sm-4 item">
                    <div class="testimonial-item1 text-center">
                        ...
                        <div class="author-info mt-2">
                            <a href="#"><img src="images/destination/testimonial/testimonial3.png" alt=""></a>
                            <div class="author-title">
