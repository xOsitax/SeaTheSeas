        ...
        <div class="breadcrumb-outer pt-10">
            <div class="container">
                <div class="breadcrumb-content d-md-flex align-items-center pt-10">
                    <h2 class="mb-0">Southern Italy Destinations</h2>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index-1.html">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Southern Italy</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-single">
                        <div class="blog-imagelist mb-3">
                            <img src="images/ItalyPhotos/Amalfi Coast/emeraldcave.png" alt="image located in Southern Italy"> <!--Photo by <a href="https://unsplash.com/@jestspoko?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Łukasz Czechowicz</a> on <a href="https://unsplash.com/s/photos/northern-italy?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                            -->
                            <p><strong>Grotto dello Smeraldo ("The Emerald Cave") located a few kilometers outside Amalfi. </strong></p>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 col-md-2">
                                <div class="date text-center bg-pink p-2">
                                    <h1 class="day mb-0 white">18</h1>
                                    <div class="month white">November</div>
                                </div>
                            </div>
                            <div class="col-lg-10 col-md-10">
                                <div class="blog-content mb-4 pt-0">
                                    <h3 class="blog-title"><a href="blog-single.html" class="yellow">There is NO Place like Southern Italy</a></h3>
                                    <div class="para-content mb-2">
                                       <span class="mr-2"><a href="#" class="tag pink"><i class="fa fa-tag mr-1"></i> Popular </a></span>
                                       <span class="mr-2"><a href="#" class="pink"><i class="fa fa-user mr-1"></i> Mario</a></span>
                                       <span><a href="#" class="pink"><i class="fa fa-comment"></i> 20</a></span> 
                                    </div>
                                    <p>Southern Italy is absolutely stunning. It is home to many tourist attractions like Pompeii, the Amalfi Coast, and other archaeological sites. Three southern Italy regions included are Sicily, Positano, and the Amalfi Coast. Sicily is famous for its cathedrals, vineyards, island beaches, and stunning architecture. Positano is famous for being a scenic seaside paradise in Italy. The Amalfi Coast is famous for its picturesque seaside towns, cliffs, and beaches. These towns include Amalfi, Positano, Praiano, Atrani, Furore, Maiori, Conca dei Marini, Anerola, and Scala.</p>
                                    <p class="mb-0"><strong></strong></p>
                                </div>

                                <!-- blog blockquote -->
                                <div class="blog-quote mb-4">
                                    <p class="white">“The world is a book and those who do not travel read only one page.” </p>
                                    <span class="white"><em>- Saint Augustine</em></span>
                                ...
                                <div class="blog-imagelist mb-4">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <img src="images/ItalyPhotos/Sicily/monreale.png" alt="image">
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <img src="images/ItalyPhotos/Postiano/pathlemons.png" alt="image">
                                    </div>
                                    </div>
                                </div>    

                                <p class="mb-4">The photo on the left is the Cathedral of Monreale. It reflects the politics, religion, and artisitc heights of Sicily under the Normans. The cost of admission is 4 euros and it is both mobility and child friendly. The photo on the right is the Path of Lemons. This is a 2.4 mile hiking trail named after a grove of lemon trees that line the path. It is located in Positano. It is not suitable for those who need mobility accommodations and is child friendly with the exception for baby strollers.</p>
