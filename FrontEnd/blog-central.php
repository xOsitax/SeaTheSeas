        ...
        <div class="breadcrumb-outer pt-10">
            <div class="container">
                <div class="breadcrumb-content d-md-flex align-items-center pt-10">
                    <h2 class="mb-0">Central Italy Destinations</h2>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index-1.html">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Central Italy</li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-single">
                        <div class="blog-imagelist mb-3">
                            <img src="images/ItalyPhotos/Rome/colosseum.png" alt="image located in Northern Italy"> <!--Photo by <a href="https://unsplash.com/@jestspoko?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Łukasz Czechowicz</a> on <a href="https://unsplash.com/s/photos/northern-italy?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                            -->
                            <p><strong>Colosseum located in Rome</strong></p>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <div class="blog-content mb-4 pt-0">
                                    <h3 class="blog-title"><a href="blog-single.html" class="yellow">There is NO Place like Central Italy</a></h3>
                                    ...
                                    <p>Central Italy is known as the crown of its country due to its most iconic landmarks like the leaning tower of Pisa, the Colosseum, and the Vatican. Rome is famous for the Colosseum and the Roman Forum. This city is home to a lot of ancient history as well as the Spanish Steps and the Trevi Fountain. Tuscany is known for its landscapes, history, influence on high culture, and artistc legacy. It is also regarded as the birthplace of the Italian Renaissance. </p>
                                    <p class="mb-0"></p>
                                </div>

                                <!-- blog blockquote -->
                                <div class="blog-quote mb-4">
                                    <p class="white">“Not all those who wander are lost” </p>
                                    <span class="white"><em>- J.R.R. Tolkien</em></span>
                                ...
                                <div class="blog-imagelist mb-4">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <img src="images/ItalyPhotos/Rome/vatican.png" alt="image">
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <img src="images/ItalyPhotos/Tuscany/towerofpisa.png" alt="image">
                                    </div>
                                    </div>
                                </div>    

                                <p class="mb-4">The photo on the left is the Vatican City located in Rome. It is the smallest state in Europe and is where the Pope lives. The palace is open to the public, but visitors have to book in advance. There are Vatican Museums where more than 20,000 articles of history and art are on display. The photo on the left is the Leaning Tower of Pisa. This is a structure of medieval Europe that stands 60 meters tall and begun to lean dring construction as a part of malleable soil. </p>
