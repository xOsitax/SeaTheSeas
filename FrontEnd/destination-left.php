...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zxx">
        ...
        <div class="breadcrumb-outer pt-10">
            <div class="container">
                <div class="breadcrumb-content d-md-flex align-items-center pt-10">
                    <h2 class="mb-0">See the Seas Dashboard</h2>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index-1.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">See the Seas Dashboard</li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="trend-box">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 mb-4">
                                <div class="trend-item">
                                    <div class="trend-image">
                                        <img src="images/ItalyPhotos/Amalfi Coast/amalficathed.png" alt="image">
                                    </div>
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <h4><a href="#">Duomo di Sant'Andrea</a></h4>
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i>Amalfi Cathedral<i class="fa fa-map-marker mr-1 ml-3"></i>Amalfi Coast</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A 9th-century medieval Roman Catholic cathedral in the Piazza del Duomo, Amalfi, Italy. It is dedicated to the Apostle Saint Andrew.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                                <div class="trend-price">
                                                    <p class="price white mb-0">Tickets From: <span>£3</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 mb-4">
                                <div class="trend-item">
                                    <div class="trend-image">
                                        <div class="ribbon ribbon-top-left"><span>5% OFF</span></div>
                                        <img src="images/ItalyPhotos/Amalfi Coast/amalfitour.png" alt="image">
                                    </div>
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            <div class="rating pb-1">
                                            ...
                                            <h4><a href="#">Amalfi Coast Private Full-Day Trip</a></h4>
                                            <p class="mb-0 pink">Leaves from Naples <i class="fa fa-map-marker mr-1 ml-3"></i> Amalfi Coast</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">Explore the towns and villahes along the Amalfi Coast in the luxury of a private car or minivan.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                                <p class="mb-0 white">Accessible/Child Friendly</p>
                                                <div class="trend-price">
                                                    <p class="price white mb-0">From <span>$210.00</span></p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 mb-4">
                                <div class="trend-item">
                                    <div class="trend-image">
                                        <img src="images/ItalyPhotos/Amalfi Coast/atrani.png" alt="image">
                                    </div>
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            <div class="rating pb-1">
                                            ...
                                            <h4><a href="#">Atrani</a></h4>
                                            <p class="mb-0 pink"><i class="fa fa-map-marker mr-1 ml-3"></i> Between Mount Civita and Mount Aureo</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A coastal fishing village with a population of less than one thousand. Climb the steps from the beach level, experience the thirteenth-century baroque churches and piazzas.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                                <div class="trend-price">
                                                    <p class="price white mb-0"><span>FREE</span> at most shoreline locations</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 mb-4">
                                <div class="trend-item">
                                    <div class="trend-image">
                                        <img src="images/ItalyPhotos/Amalfi Coast/ferriere.png" alt="image">
                                    </div>
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <h4><a href="#">Vallone delle Ferriere</a></h4>
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 255 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> Top of Amalfi</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">Hike the Vallone delle Ferriere (Valley of the Ferriere) named for the medieval foundaries. Hike to see the waterfall!</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                                <div class="trend-price">
                                                    <p class="price white mb-0">Waterfall Entrance costs <span>$3.00</span></p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="trend-item">
                                    ...
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 852 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> Indonesia.</p>
                                        </div>
                                        <div class="trend-last-main">
                                ...
                                <div class="trend-item">
                                    ...
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            ...
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 255 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> Mexico.</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A wonderful little cottage right on the seashore - perfect for exploring.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                                    ...
                                    <div class="trend-content-main">
                                        <div class="trend-content">
                                            <div class="rating-main d-flex align-items-center pb-1">
                                                ...
                                                <span class="ml-2">65 Reviews</span>
                                            </div>
                                            <h4><a href="#">Dazzling Dubai</a></h4>
                                            <p class="mb-0 pink"><i class="fa fa-eye mr-1"></i> 852 Visiting Places <i class="fa fa-map-marker mr-1 ml-3"></i> Dubai.</p>
                                        </div>
                                        <div class="trend-last-main">
                                            <p class="mb-0 trend-para">A wonderful little cottage right on the seashore - perfect for exploring.</p>
                                            <div class="trend-last d-flex align-items-center justify-content-between bg-navy">
                        ...
                        <div class="list-sidebar">
                            <div class="sidebar-item">
                                ...
                                <div class="pretty p-default p-thick p-pulse mar-bottom-15">
                                    <input type="checkbox" />
                                    <div class="state p-warning-o">
                                        <label>Low Cost per Person</label>
                                    </div>
                                </div>
                            </div>
                            <div class="sidebar-item">
                            ...
                            <div class="sidebar-item">
                                ...
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Amalfi Coast<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Milan<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Positano<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Rome<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Sicily<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Tuscany<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Venice<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="pretty p-default p-thick p-pulse">
                                    ...
                                    <div class="state">
                                        <label>
                                            Verona<span class="number">10</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Back to top start -->
    <div id="back-to-top">
        <a href="destination-left.html"></a>
    </div>
    <!-- Back to top ends -->
