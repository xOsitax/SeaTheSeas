        ...
        <div class="breadcrumb-outer pt-10">
            <div class="container">
                <div class="breadcrumb-content bread-content text-center pt-10">
                    ...
                    <h2 class="mb-0 white text-uppercase">Rome's Top Destinations</h2>
                </div>
            </div>
        </div>
                        ...
                        <div class="description" id="description">
                            <div class="single-full-title border-b mb-2 pb-2">
                                <div class="single-title">
                                    <h3 class="mb-1">Vatican City, Castel Sant'Angelo, the Colosseum, Villa Borghese, a Gelato Lovers Workshop etc...</h3>
                        ...
                        <div class="accrodion-grp faq-accrodion mb-4" id="iternary" data-grp-name="faq-accrodion">
                            ...
                            <div class="accrodion active">
                                <div class="accrodion-title">
                                    <h5 class="mb-0"><span>Itinerary 1</span> - Best of Luxury Italy</h5>
                                </div>
                            ...
                            <div class="accrodion ">
                                <div class="accrodion-title">
                                    <h5 class="mb-0"><span>Itinerary 2</span> - Fully Immersive Tour of Italy: Highlights and Hidden Gems</h5>
                                </div>
                            ...
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h5 class="mb-0"><span>Itinerary 3</span> - Food-Lovers Tour of Umbria and Tuscany</h5>
                                </div>
                                <div class="accrodion-content" style="display: none;">
                                    <div class="inner">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, inventore cumque veniam, praesentium velit incidunt rem quas a, quos eos ipsum, reprehenderit voluptatem.</p>
                            ...
                            <div class="accrodion ">
                                <div class="accrodion-title">
                                    <h5 class="mb-0"><span>Itinerary 4</span> - Italian Adventure Rome, Amalfi Coast and Sicily</h5>
                                </div>
                                <div class="accrodion-content" style="display: none;">
                                    <div class="inner">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, inventore cumque veniam, praesentium velit incidunt rem quas a, quos eos ipsum, reprehenderit voluptatem.</p>
